...
public class Kuis {
    public static void main(String[] args) {
        ...
        int arr[] = {45,21,71,6,30,55,82,2,12,40,63,35,43,60,67,37};
        for (int i = 0; i < arr.length; i++) {
            a.insert(arr[i]);
        }
        System.out.println(a.getSiblingOf(2)); 
        
    }
}


class BinaryTree {                   //inisialisasi kelas bernama BinaryTree.
    ...
    public TreeNode getSiblingOf(int data){
